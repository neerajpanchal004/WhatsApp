...
const Chats = () => {
  return (
    <>
      {/* first-slide */}
      <div className=" flex p-2 my-2 sm:justify-center">
        <Image
          alt="whatsapp clone user image"
        ...
        <div className="mx-2">
          ...
          <div className="flex justify-between ">
            ...
            <p className="bg-emerald-700 w-6 text-center rounded-full text-white text-xs p-1 mx-2">
              4
            </p>
          </div>
        </div>
