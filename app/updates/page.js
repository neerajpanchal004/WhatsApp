  ...
  return (
    <>
      <div className="flex sm:justify-center">
        <div className="flex justify-between items-center w-96 px-4 pt-4">
      ...
      <div className="flex justify-center">
        <div className="flex max-w-sm w-96">
          {/* first */}
      ...
      <div className="m-2  flex sm:justify-center">
        <div className="flex justify-between items-center w-96 p-2 pt-4">
          <h3 className="font-bold">Find Channels</h3>
          <h5 className="text-emerald-900 text-xs">See all {">"} </h5>
        </div>
      </div>
      {/* channal cart */}
      <div className="flex gap-3 sm:justify-center flex-wrap p-3">
        {/* first card */}
        <div className="flex-col  px-3 py-5 w-28 border-2 rounded-lg">
          ...
          ></Image>
          <p>Cravings</p>
          <button className="py-1  px-4 rounded-full bg-green-300 text-emerald-800 text-xs">
            Follow
          </button>
        </div>
        {/* first card end */}
        ...
        <div className="flex-col px-3 py-5 w-28 border-2 rounded-lg">
          ...
          ></Image>
          <p>ABP News</p>
          <button className="py-1  px-4 rounded-full bg-green-300 text-emerald-800 text-xs mx-2">
            Follow
          </button>
        </div>
        {/* second card end */}
        ...
        <div className="flex-col px-3 py-5 w-28 border-2 rounded-lg">
          <Image
            ...
            width="40"
            height="10"
            className="m-auto rounded-full mb-3"
          ></Image>
